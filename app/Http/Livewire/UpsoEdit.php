...
class UpsoEdit extends Component
{
    ...
    public $removeUserImages = 0, $removeThumb =0 , $removeUserFiles = 0,  $removeTorrentFiles = 0,  $removeTorrentImages= 0 ; 
...
// 
    ...
    protected function doRemovePhotos( $upso ){
        $upso->all_images()->delete();
    }


    protected function insertPhotos( $upso, $photos, $editmode = true ){
