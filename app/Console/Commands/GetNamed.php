...
class GetNamed extends Command
{
    ...
    function checkWinLose($sport_name, $betting,  $bet_type_id, $result) {
...
// {"event_date":"2019-08-13","round":"74","side":"RIGHT","lines":"4","oe":"EVEN"}
    ...
    function saveDB( $mini_sport_id ,$game, $json ) {
    ...
    function callPowerBall($game, $response){
    ...
    function callLadder($game, $response){
      $start_string = '({';
      $end_string = '});';
    ...
    function callDari($game, $response){
    ...
    function callRacing($game, $response){
      $data = json_decode($response, true);
