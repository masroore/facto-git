...
{
    protected $signature = 'horse:day {mode?}';
    ...
    public function handle()
    {
        ...
        if ($mode == 'today') {
            ...
            $date_index = Carbon::today()->subDays(2)->toDateString();
            $sdate = Carbon::today()->subDays(2)->toDateString();
            $edate = Carbon::today()->subDays(2)->toDateString();
        } else {
            sleep(3);
